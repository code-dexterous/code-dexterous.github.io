              ...
              >
                ...
                <div class="post-content">
                  ...
                  <div class="post-meta d-flex">
                    ...
                    >
                    <a href="#"
                      ><i class="fa fa-eye" aria-hidden="true"></i> 25</a
                    >
                    <a href="#"
                ...
                <div class="single-post-area mb-80">
                  ...
                  <div class="post-content">
                    ...
                    <div class="post-meta d-flex">
                      ...
                      >
                      <a href="#"
                        ><i class="fa fa-eye" aria-hidden="true"></i> 17</a
                      >
                      <a href="#"
                        ><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
                        22</a
            ...
            <div class="row mb-30">
              <div class="col-12 col-lg-6">
                <div class="single-blog-post style-3 d-flex mb-50">
                  ...
                  <div class="post-content">
                    <a href="single-post.html" class="post-title"
                      >Epileptic boy's cannabis let through border</a
                    >
                    <div class="post-meta d-flex justify-content-between">
                      ...
                      >
                      <a href="#"
                        ><i class="fa fa-eye" aria-hidden="true"></i> 26</a
                      >
                      <a href="#"
                        ><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>
                        17</a
              ...
              <div class="col-12 col-lg-6">
                <div class="single-blog-post style-3 d-flex mb-50">
                  ...
                  <div class="post-content">
                    <a href="single-post.html" class="post-title"
                      >Paramedics 'drilled into boat death woman'</a
                    >
                    <div class="post-meta d-flex justify-content-between">
                      <a href="#"
                        ><i class="fa fa-comments-o" aria-hidden="true"></i>
              ...
              <div class="col-12 col-lg-6">
                <div class="single-blog-post style-3 d-flex mb-50">
                  ...
                  <div class="post-content">
                    <a href="single-post.html" class="post-title"
                      >Tory vice-chairs quit over PM's Brexit plan</a
                    >
                    <div class="post-meta d-flex justify-content-between">
                      <a href="#"
                        ><i class="fa fa-comments-o" aria-hidden="true"></i>
              ...
              <div class="col-12 col-lg-6">
                <div class="single-blog-post style-3 d-flex mb-50">
                  ...
                  <div class="post-content">
                    <a href="single-post.html" class="post-title"
                      >Do This One Simple Action for an Absolutely</a
                    >
                    <div class="post-meta d-flex justify-content-between">
                      <a href="#"
                        ><i class="fa fa-comments-o" aria-hidden="true"></i>
                ...
                <div class="col-12 col-lg-6">
                  <div class="post-content mt-0">
                    ...
                    <a href="single-post.html" class="post-title mb-2"
                      >May fights on after Johnson savages Brexit approach</a
                    >
                    ...
                    <p class="mb-2">
                      Quisque mollis tristique ante. Proin ligula eros, varius
                      id tristique sit amet, rutrum non ligula.
                    </p>
                    <div class="post-meta d-flex">
                      <a href="#"
                        ><i class="fa fa-comments-o" aria-hidden="true"></i>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                  <div class="post-content mt-0">
                    ...
                    >
                    <a href="single-post.html" class="post-title mb-2"
                      >Theresa May battles Brexiteer backlash amid disquiet</a
                    >
                    <div class="post-meta d-flex align-items-center mb-2">
                      <a href="#" class="post-author">By Jane</a>
                      <i class="fa fa-circle" aria-hidden="true"></i>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                  <div class="post-content mt-0">
                    <a href="#" class="post-cata cata-sm cata-danger">Game</a>
                    <a href="single-post.html" class="post-title mb-2"
                      >Theresa May warned Brexit strategy 'risks putting Jeremy
                      Corbyn</a
                    >
                    <div class="post-meta d-flex align-items-center mb-2">
                      <a href="#" class="post-author">By Jane</a>
            ...
            <div class="single-widget latest-video-widget mb-50">
              ...
              <div class="single-blog-post d-flex">
                ...
                <div class="post-content">
                  ...
                  <div class="post-meta d-flex justify-content-between">
                    <a href="#"
                      ><i class="fa fa-comments-o" aria-hidden="true"></i> 29</a
                    >
                    <a href="#"
              ...
              <div class="single-blog-post d-flex">
                ...
                <div class="post-content">
                  ...
                  <div class="post-meta d-flex justify-content-between">
                    <a href="#"
                      ><i class="fa fa-comments-o" aria-hidden="true"></i> 17</a
                    >
                    <a href="#"
              ...
              <div class="single-blog-post d-flex">
                ...
                <div class="post-content">
                  ...
                  <div class="post-meta d-flex justify-content-between">
                    <a href="#"
                      ><i class="fa fa-comments-o" aria-hidden="true"></i> 11</a
                    >
                    <a href="#"
                      ><i class="fa fa-eye" aria-hidden="true"></i> 42</a
                    >
